import wedowebapps from "../assets/images/wedowebapps.png";
...
import targetAlign from "../assets/images/target-align.png";
const portfolioDataList = [
  {
    id: 1,
    imageGet: wedowebapps,
    alt: "image1",
    title: "Html",
    category: "html",
    link: [
      {
        linkText: "WeDoWebApps",
        url: "https://www.wedowebapps.com/",
      },
    ],
    peragraph: [
      "sdkcnfskjnv jsfkbn vjksfba v jksbaf vkj bfsakjvfjk vbjdfskbv kjbdfscv kjbfvjk bfjskv bb",
  ...
  {
    id: 4,
    imageGet: targetAlign,
    alt: "image4",
    title: "React Js",
    category: "react",
    link: [
      {
        linkText: "Target Align",
        url: "https://creole.uat1950.com/",
      },
      {
        linkText: "Frimarked",
  ...
  },
  {
    ...
    badges: ["React Js", "Css", "Sass", "Bootstrap"],
    thumnailImages: [
      portfolioImg1,
      portfolioImg2,
      portfolioImg3,
